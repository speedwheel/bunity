...
var (
	apiKey       = "AIzaSyD62v5PoWpYDt0Fg-Rbu54V54CuRWq7O3Q" //API Key for using Google Maps API.
	clientID     = "" //ClientID for Maps for Work API access.
	signature    = "" //Signature for Maps for Work API access.
	...
	resultType   = "" //One or more address types, separated by a pipe (|).
	locationType = "GEOMETRIC_CENTER" //"One or more location types, separated by a pipe (|).
)

func MapsInit(address string) []maps.GeocodingResult {
	address = address
